...
# Don't save duplicate commands or commands starting with a space
export HISTCONTROL=ignoreboth:erasedups

# Save timestamp for each command (YYYY-MM-DD HH:MM:SS)
...
export GIT_PS1_SHOWUPSTREAM="auto"   # Shows '<' or '>' if behind/ahead of remote

# Inject Git branch info into your prompt
...
__kubectl_handle_standard_completion_case() {
    ...
    if ((${#COMPREPLY[*]} == 1)); then
        ...
        __kubectl_debug "Removed description from single completion, which is now: ${COMPREPLY[0]}"
    else
...
# Theme
# 1. Shorten Git prompt indicators to single symbols
...
# 2. Format PS1 with colors and cleaner spacing
# - Green user@host
# - Bold Blue directory (shortened path \w)
# - Yellow Git branch
# export PS1='\[\e[1;34m\]\w\[\e[0m\]\[\e[1;33m\]$(__git_ps1 " (%s)")\[\e[0m\]\$ '

# ---------- Environment indicator  [ With toolbox ] ----------
...
PS1='\[\e[1;34m\]\w\[\e[0m\] \[\e[1;33m\]$(__git_ps1 "(%s)")\[\e[0m\] \[\e[1;36m\]$(__shell_context)\[\e[0m\] \$ '

# Source custom bash functions and aliases
